...
type XSDComplexType struct {
	...
	SequenceSequenceSequence []*XSDElement        `xml:"sequence>sequence>sequence>element"`
}
...
func addDisplayNameForComplexTypes(targetNameSpaceName string, complexType *XSDComplexType) {
	...
	if complexType.SequenceSequenceSequence != nil {
		for _, element := range complexType.SequenceSequenceSequence {
			checkNameSpace(targetNameSpaceName, element)
		}
	}
